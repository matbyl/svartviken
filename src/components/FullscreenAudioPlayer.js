...
const Container = styled.div`
  ${tw`fixed z-50 flex flex-col h-full w-full m-auto justify-center bg-black z-50`}
`
...
const FullscreenAudioPlayer = ({ title, supTitle, filename, close }) => {
  ...
  return (
    <Container>
      <MediaButton onClick={close} className="align-right">
        <img src={CloseIcon} />
      </MediaButton>
      <div className="flex-grow">PLACEHOLDER</div>
      {supTitle ? (
        <Title>
